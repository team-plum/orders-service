    ...
    if (this.state.radioInput) {
      return (
        ...
        <div id='radio_container'>
          <input id='delivery' value='delivery' name='platform' type='radio' checked={this.state.radioInput} onChange={this.onRadioDeliveryChange.bind(this)}/><span class='radioText'>Delivery</span>
          <input id='takeout' value='takeout' name='platform' type='radio' checked={!this.state.radioInput} onChange={this.onRadioTakeoutChange.bind(this)}/><span class='radioText'>Takeout</span>
        </div>
        <OrderFoodInfo 
